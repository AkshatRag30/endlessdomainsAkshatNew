...
import styles from './UdHero.module.scss'
...
export function UdHero({ onGetStarted }: UdHeroProps) {
  ...
  return (
    <section className={styles.section} aria-labelledby="ud-hero-heading">
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.gridZone}>
          ...
          <h1 id="ud-hero-heading" className={styles.heading} ref={headingRef}>
            Register Through
            <br />
        ...
        <p className={styles.body} ref={bodyRef}>
          Access 55 Web3-native TLDs from the world's largest decentralized naming provider.
          <br />
          Permanent ownership. No renewal fees. Starting from $5.
        </p>
