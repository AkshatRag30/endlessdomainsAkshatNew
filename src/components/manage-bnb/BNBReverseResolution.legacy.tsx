...
import { handleGetReverseRecord, handleUpdateReverseRecord } from '@/helpers/bnb'

import ToastMessage from '../toast-message'
import { BiError } from 'react-icons/bi'
import { getDomainProvider } from '@/helpers/chaincurrency/chaincurrency'

const BNBReverseResolution = ({ domain }: { domain: string }) => {
...
export default BNBReverseResolution
