...
import { handleTransferDomain } from '@/helpers/ens'
import ToastMessage from '../toast-message'
import * as apiService from '@/core/services/api.service'
import { API_ENDPOINT } from '@/core/enum/api-endpoint.enum'
import { useRouter } from 'next/router'
import CurrencyModal from '../manage-ud/CurrencyModal'
import { BiError } from 'react-icons/bi'

const ENSTransfer = ({ domain }: { domain: string }) => {
  ...
  return (
    <div className={`${btnstyles.sidenav_item} h-auto mt-3 py-4`}>
      <CardHeader>
        <h1>Transfer your ENS domain to another wallet</h1>
      ...
      <CardBody>
        ...
        <Row>
          <Col>
            ...
            <input
              ...
              placeholder="Enter your ETH/Polygon Address"
              style={{
                width: '80%',
                padding: '10px',
                borderRadius: '8px',
          ...
          <Col>
            <div className="form-check">
              ...
              <label htmlFor="agree-clause-3" style={{ color: agreements.c3 == true ? '#000' : 'rgb(103 103 103)' }}>
                I&apos;m transferring this domain to an ETH or Polygon Address.
              </label>
            </div>
          </Col>
        </Row>
        ...
        <Col>
          {/* <Button onClick={openModal}>Add Currency</Button> */}
        </Col>
      </CardBody>
      {/* {isOpen && <CurrencyModal onClose={closeModal} />} */}
    </div>
  )
}
