...
import styles from './ENSReverseNew.module.scss'

interface ENSReverseNewProps {
  domain: string
  currentRecord: string
}

export function ENSReverseNew({ domain, currentRecord }: ENSReverseNewProps) {
