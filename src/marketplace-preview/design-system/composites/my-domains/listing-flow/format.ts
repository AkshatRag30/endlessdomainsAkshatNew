// Shared formatting for the listing flow modal — every screen in this flow
// shows raw token amounts with 2 decimals (e.g. "8,000.00") rather than
// formatMyDomain.ts's rounded "$1,234" table convention, since the token
// symbol is always shown separately as its own chip/suffix here.
