...
// slot as every other row. Fill is Figma-exact (#2639ED, matches
// --color-blue-primary) and intentionally not currentColor — this icon is
// only ever used for this one always-blue row, unlike the react-icons rows
// that need to inherit the active/inactive row color.
