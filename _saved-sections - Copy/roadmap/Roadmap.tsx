    ...
    const ctx = gsap.context(() => {
      ...
      checkRefs.current.forEach((el, i) => {
        ...
        ScrollTrigger.create({
          ...
          onEnter: () => gsap.to(el, { opacity: 1, duration: 0.55, ease: 'power2.out', overwrite: true }),
          onLeave: () => gsap.to(el, { opacity: 0, duration: 0.35, ease: 'power2.in', overwrite: true }),
          onEnterBack: () => gsap.to(el, { opacity: 1, duration: 0.55, ease: 'power2.out', overwrite: true }),
          onLeaveBack: () => gsap.to(el, { opacity: 0, duration: 0.35, ease: 'power2.in', overwrite: true }),
        })
      })
